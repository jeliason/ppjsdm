...
// [[Rcpp::export]]
Rcpp::List get_sr_disp_papangelou_cpp(SEXP configuration,
  ...
  const ppjsdm::Truncated_exponential_family_model<Rcpp::NumericVector> exponential_model(beta0, model,
                                                                                          ...
                                                                                          saturation);
  return Rcpp::wrap(exponential_model.get_short_range_dispersion_vectorized(points, wrapped_configuration, nthreads));
}

// [[Rcpp::export]]
Rcpp::List get_mr_disp_papangelou_cpp(SEXP configuration,
                                           Rcpp::NumericVector x,
                                           Rcpp::NumericVector y,
                                           Rcpp::List model,
                                           Rcpp::CharacterVector medium_range_model,
  ...
  const ppjsdm::Truncated_exponential_family_model<Rcpp::NumericVector> exponential_model(beta0, model,
                                                                                          ...
                                                                                          medium_range, long_range,
                                                                                          saturation);
  return Rcpp::wrap(exponential_model.get_medium_range_dispersion_vectorized(points, wrapped_configuration, nthreads));
}

// [[Rcpp::export]]
Rcpp::List get_beta_covariates_papangelou_cpp(SEXP configuration,
                                           Rcpp::NumericVector x,
                                           Rcpp::NumericVector y,
                                           Rcpp::List model,
                                           Rcpp::CharacterVector medium_range_model,
  ...
  const ppjsdm::Truncated_exponential_family_model<Rcpp::NumericVector> exponential_model(beta0, model,
                                                                                          ...
                                                                                          medium_range, long_range,
                                                                                          saturation);
  return Rcpp::wrap(exponential_model.compute_beta_covariates_vectorized(points, wrapped_configuration, nthreads));
}